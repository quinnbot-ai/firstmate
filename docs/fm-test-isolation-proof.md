...
| Retained fork contracts | `fm-continuity-pretool-check`, `fm-dispatch-select` | Restored or changed during upstream reconciliation; serial until the concurrent proof is refreshed |
