...
Each update stages and validates a complete generation, then publishes its records, searchable index, history, and transcripts through one atomic `current` switch.
