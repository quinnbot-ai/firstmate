...
It also retains dated metadata archives created by the explicit legacy reconciliation command; [`fm-meta-reconcile.sh`](../bin/fm-meta-reconcile.sh)'s header owns candidate selection, proof, dry-run, mutation, and archive mechanics.
