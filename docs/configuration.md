...
Any absent, malformed, unreadable, incomplete, stale, or disagreeing source renders its figures unavailable under a named reason rather than zero, while quota-axi windows remain provider-reported windowed measurements rather than exact monetary costs.
