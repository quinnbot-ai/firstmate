...
4. Ordinary wake: if the command prints `signal:`, `stale:`, `stale-rechecks:`, `check:`, or `heartbeat`, drain queued wakes, handle that wake, then start the next checkpoint.
