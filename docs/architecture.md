...
Newly offered mentions are stored as `state/x-inbox/<request_id>.json`; the [X mode configuration reference](configuration.md#x-mode-env) owns the durable offer-marker and re-offer contract.
