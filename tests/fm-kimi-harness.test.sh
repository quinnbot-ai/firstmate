...
test_existing_launch_templates_are_byte_pinned() {
  ...
  assert_source_line "        printf '%s' 'codex --profile __CODEXPROFILE__ --disable plugins __MODELFLAG____EFFORTFLAG__--dangerously-bypass-approvals-and-sandbox -c \"notify=[\\\"bash\\\",\\\"-c\\\",\\\"touch __TURNEND__\\\"]\" \"\$(__OPINPUT__ encode launch-brief < __BRIEF__)\"'"
