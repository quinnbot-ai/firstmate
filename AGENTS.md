...
config/calm     Calm presentation preference shared by the Pi and Claude adapters; LOCAL, gitignored, and not inherited; see docs/configuration.md "Calm preference"
