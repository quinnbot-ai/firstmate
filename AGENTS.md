...
state/               runtime records and signals; gitignored
  ...
  <id>.zellij-lifecycle <id>.zellij-exited  Zellij launch nonce and its nonce-bound exit receipt, the only proof recovery has that a Zellij task's agent returned; written by fm-spawn and the pane's own shell, removed by teardown
