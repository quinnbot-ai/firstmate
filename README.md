...
| `/agent-retro`     | Report a bounded, read-only retrospective of this home's recent task records: source coverage, task mix, recorded outcome categories, and approval-gated proposals, with no cause attributed and no harness, model, or worker ranked |
