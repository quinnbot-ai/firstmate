...
family_for_basename() {
  case "$1" in
    ...
    fm-claude-auth.test.sh|fm-claude-home.test.sh|fm-grok-harness.test.sh|fm-kimi-harness.test.sh|\
    fm-herdr-lab.test.sh|fm-instruction-owners.test.sh|fm-lint.test.sh|\
    fm-install-herdr.test.sh|fm-nm-test-contract.test.sh|fm-no-mistakes-ownership.test.sh|fm-pr-capability.test.sh|\
    ...
    fm-update.test.sh)
      printf '%s\n' session-bootstrap
      ;;
    fm-afk-pi-herdr-return-e2e.test.sh|fm-claude-continuity-live-e2e.test.sh|fm-claude-stop-autoarm-live-e2e.test.sh|\
