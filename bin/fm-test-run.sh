...
family_for_basename() {
  case "$1" in
    ...
    fm-classify-decision-key.test.sh|fm-condition-hold.test.sh|\
...
families_for_changed_path() {
  ...
  case "$path" in
    ...
    bin/fm-condition-hold.sh|bin/fm-decision-hold.sh|bin/fm-supervision*|bin/fm-transition-lib.sh|\
